...
const featuredProjects = [
  {
    ...
    description:
      "A suite of AI-powered tools including Automation, CLI, ChatWeb, and WebBuilder. Built for solopreneurs who want to ship faster.",
  ...
  },
  {
    ...
    description:
      "Upload any PDF and generate AI-powered quizzes instantly. Perfect for educators and self-learners.",
  ...
  },
  {
    ...
    description:
      "Military-grade password generation with entropy analysis. No data leaves your browser.",
    ...
    github:
      "https://github.com/mk-knight23/tool-vaultpass-secure-password-generator",
  },
  {
    id: "viral-creator",
    name: "Viral Creator",
    ...
    description:
      "Tools and templates for creating viral social media content. Built for creators, by a creator.",
  ...
  },
  {
    ...
    description:
      "Personalized career roadmaps based on your skills and market trends.",
  ...
  },
  {
    ...
    description:
      "Discover recipes from around the world with smart filtering and meal planning.",
  ...
  },
  {
    ...
    description:
      "Collection of addictive mini-games built with modern web tech. No installs, just play.",
  ...
  },
  {
    ...
    description:
      "You are here. Built to demonstrate that I can ship polished products fast.",
...
const allProjects = {
  portfolios: [
    {
      name: "DevTools Portfolio",
      desc: "Terminal-inspired developer portfolio",
      tech: "Vite + React + TS",
    },
    {
      name: "Fullstack Portfolio",
      desc: "Product-focused SaaS showcase",
      tech: "Next.js + React + TS",
    },
    {
      name: "Frontend Portfolio",
      desc: "Motion-first visual experience",
      tech: "Vite + React + TS",
    },
    {
      name: "Backend Portfolio",
      desc: "Editorial text-dominant design",
      tech: "Node.js + Express",
    },
    {
      name: "Frontend AI Portfolio",
      desc: "Futuristic AI lab aesthetic",
      tech: "Next.js + React + TS",
    },
    {
      name: "Senior Frontend Portfolio",
      desc: "Swiss minimal design",
      tech: "Next.js + React + TS",
    },
    {
      name: "Indie SaaS Portfolio",
      desc: "This site — authentic indie hacker",
      tech: "React + Vite + Tailwind",
    },
    {
      name: "AI Automation Portfolio",
      desc: "Systems flow visualization",
      tech: "Next.js + React + TS",
    },
  ],
  webApps: [
    {
      ...
      desc: "Interactive map exploration",
      tech: "React + Map APIs",
    },
    {
      name: "Time Display",
      desc: "Beautiful timezone visualizer",
      tech: "React + Canvas",
    },
    {
      name: "Keyboard Practice",
      desc: "Typing speed trainer",
      tech: "React + TypeScript",
    },
    {
      name: "Editorial Blog",
      desc: "Content-focused blog platform",
      tech: "Next.js + MDX",
    },
    {
      name: "Brutalist Content",
      desc: "Raw, honest web design",
      tech: "HTML + CSS",
    },
    {
      name: "AI Research",
      desc: "AI paper discovery tool",
      tech: "React + AI APIs",
    },
    {
      name: "Luxury Boutique",
      desc: "High-end e-commerce UI",
      tech: "React + Tailwind",
    },
    {
      name: "Editorial Layouts",
      desc: "Magazine-style layouts",
      tech: "React + Grid",
    },
    {
      name: "Culinary Discovery",
      desc: "Recipe exploration platform",
      tech: "React + PWA",
    },
    {
      name: "Atmospheric Dashboard",
      desc: "Weather + mood dashboard",
      tech: "Angular + APIs",
    },
    {
      name: "Viral Creator",
      desc: "Content creation toolkit",
      tech: "React + Canvas",
    },
    {
      name: "Career Navigator",
  ...
  games: [
    ...
    {
      name: "Retro Vault",
      desc: "Classic arcade collection",
      tech: "React + Canvas",
    },
    ...
    {
      name: "Maze Net",
      desc: "Procedural maze generator",
      tech: "React + Algorithms",
    },
    {
      name: "Flux Arcade",
      desc: "Gaming hub platform",
      tech: "TypeScript + Canvas",
    },
    {
      name: "Aptitude Nexus",
      desc: "Brain training games",
      tech: "React + PWA",
    },
    {
      name: "Sigma Nexus",
      desc: "Strategy puzzle collection",
      tech: "React + State",
    },
  ],
  tools: [
    ...
    },
    {
      ...
      desc: "OAuth interface clone",
      tech: "React + CSS",
    },
    {
      name: "Agency Website Clone",
      desc: "Landing page recreation",
      tech: "HTML + CSS",
    },
    {
      name: "GitHub Desktop Guide",
      desc: "Git tutorial app",
      tech: "React + MDX",
    },
  ],
  starters: [
    {
      name: "React Vercel Starter",
      desc: "Deploy-ready React template",
      tech: "React + Vercel",
    },
    {
      name: "Ionic React Starter",
      desc: "Mobile app foundation",
      tech: "Ionic + React",
    },
    {
      name: "Django Starter",
    ...
    {
      name: "Flask Starter",
      desc: "Lightweight Python backend",
      tech: "Flask + Python",
    },
    {
      name: "JAMstack Blog",
    ...
    },
    {
      ...
      desc: "Production-ready setup",
      tech: "React + Webpack",
    },
    {
      name: "CodeSandbox Starter",
      desc: "Online IDE template",
      tech: "React + CSB",
    },
    { name: "Hugo Blog", desc: "Fast static generator", tech: "Hugo + Go" },
    {
      name: "Docusaurus Docs",
      desc: "Documentation site",
      tech: "Docusaurus + React",
    },
    {
      name: "Gatsby Blog",
      desc: "GraphQL-powered blog",
      tech: "Gatsby + React",
    },
...
const ecosystems = [
  {
    id: "60-projects",
    name: "60 Projects Ecosystem",
    tagline: "The complete collection",
    description:
      "A comprehensive ecosystem of 60+ shipped projects spanning portfolios, web apps, games, tools, and starter templates. Each project represents real-world problem solving.",
    stats: [
    ...
    link: "https://www.mkazi.live",
  },
  {
    id: "ai-vibe",
    name: "AI-VIBE Ecosystem",
    tagline: "10 AI-powered projects",
    description:
      "A next-generation AI platform featuring multi-agent workflows, CLI tools, chat interfaces, and web builders. Built for developers who want to ship faster with AI assistance.",
    stats: [
    ...
    link: "https://mk-knight23.github.io/AI-VIBE-ECOSYSTEM",
  },
  {
    id: "ai-sdk",
    name: "AI-SDK Ecosystem",
    tagline: "10 specialized SDKs",
    description:
      "A collection of 10 production-ready SDKs for AI integration. From LLM wrappers to agent frameworks, these SDKs make AI adoption seamless for any project.",
    stats: [
      { label: "SDKs", value: "10" },
      { label: "Type", value: "Libraries" },
      { label: "Status", value: "Beta" },
    ],
    icon: Workflow,
    color: "from-emerald-400 to-teal-500",
    gradient: "bg-gradient-to-br from-emerald-50 to-teal-50",
    link: "https://mk-knight23.github.io/AI-SDK-ECOSYSTEM",
  },
];
  ...
  return (
    <div className="min-h-screen bg-amber-50">
      <main className="pb-16">
        ...
        <section className="max-w-6xl mx-auto px-6 py-20 md:py-32">
          ...
          >
            ...
            <p className="text-xl text-stone-600 mb-8 leading-relaxed max-w-2xl">
              Hey, I'm Kazi. I build SaaS products and tools that solve real
              problems. 60+ projects shipped. Currently working on{" "}
            ...
            >
              ...
              <div className="space-y-4 text-stone-600 leading-relaxed">
                <p>
                  ...
                  mattered. Not just tutorials or side projects — real products
                  that real people could use.
                </p>
                <p>
                  After joining{" "}
                  <strong className="text-stone-800">Wipro</strong> as a Project
                  Engineer, I realized the 9-to-5 wasn't enough. I wanted to
                  create, to ship, to iterate in public. So I started building.
                </p>
                <p>
                  60 projects later, I've learned that shipping beats
                  perfection. Every project taught me something — about code,
                  about users, about myself. Some failed. Some stuck. All moved
                  me forward.
                </p>
                <p className="text-amber-700 font-medium">
                  Now I'm focused on AI-powered developer tools that help others
                  ship faster. Because the best products are built by people who
        ...
        {/* Ecosystems Section */}
        <section id="ecosystems" className="bg-white py-20">
          <div className="max-w-6xl mx-auto px-6">
            ...
            >
              ...
              <p className="text-stone-600 max-w-2xl mx-auto">
                Three interconnected ecosystems showcasing different facets of
                my work — from comprehensive project collections to specialized
                AI platforms and developer SDKs.
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {ecosystems.map((ecosystem, i) => (
                <motion.a
                  ...
                  className={`indie-card ${ecosystem.gradient} group cursor-pointer h-full block`}
                >
                  <div className="flex items-start justify-between mb-4">
                    <div
                      className={`w-14 h-14 rounded-xl bg-gradient-to-br ${ecosystem.color} flex items-center justify-center shadow-lg`}
                    >
                      <ecosystem.icon className="w-7 h-7 text-white" />
                    </div>
                    <span className="tag tag-amber text-xs font-semibold">
                      {ecosystem.stats[2].value}
                    </span>
                  </div>
            ...
            {/* Cross-Portfolio Navigation CTA */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="mt-12 indie-card bg-gradient-to-br from-stone-800 to-stone-900 text-white"
            >
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="text-center md:text-left">
                  <h3 className="text-xl font-bold mb-2">
                    Explore All 8 Portfolio Variants
                  </h3>
                  <p className="text-stone-400 text-sm">
                    Each portfolio showcases a different design approach and
                    specialization — from DevTools to AI Automation.
                  </p>
                </div>
                <div className="flex flex-wrap justify-center gap-2">
                  <a
                    href="https://portfolio-devtools.web.app"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all bg-stone-700 text-stone-300 hover:bg-stone-600"
                    title="DevTools — Terminal-inspired"
                  >
                    <div className="w-2 h-2 rounded-full bg-stone-800" />
                    DevTools
                  </a>
                  <a
                    href="https://mk-knight-fullstack.web.app"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all bg-stone-700 text-stone-300 hover:bg-stone-600"
                    title="Fullstack — Product-focused"
                  >
                    <div className="w-2 h-2 rounded-full bg-blue-600" />
                    Fullstack
                  </a>
                  <a
                    href="https://mk-knight-frontend.web.app"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all bg-stone-700 text-stone-300 hover:bg-stone-600"
                    title="Frontend — Motion-first"
                  >
                    <div className="w-2 h-2 rounded-full bg-purple-600" />
                    Frontend
                  </a>
                  <a
                    href="https://mk-knight-backend.web.app"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all bg-stone-700 text-stone-300 hover:bg-stone-600"
                    title="Backend — Editorial design"
                  >
                    <div className="w-2 h-2 rounded-full bg-emerald-600" />
                    Backend
                  </a>
                  <a
                    href="https://mk-knight-frontend-ai.web.app"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all bg-stone-700 text-stone-300 hover:bg-stone-600"
                    title="Frontend AI — AI lab aesthetic"
                  >
                    <div className="w-2 h-2 rounded-full bg-cyan-600" />
                    Frontend AI
                  </a>
                  <a
                    href="https://mk-knight-senior-frontend.web.app"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all bg-stone-700 text-stone-300 hover:bg-stone-600"
                    title="Senior Frontend — Swiss minimal"
                  >
                    <div className="w-2 h-2 rounded-full bg-rose-600" />
                    Senior Frontend
                  </a>
                  <span
                    className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium bg-amber-500 text-white"
                    title="Indie SaaS — You are here"
                  >
                    <div className="w-2 h-2 rounded-full bg-white" />
                    Indie SaaS
                  </span>
                  <a
                    href="https://portfolio-ai-automation.web.app"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all bg-stone-700 text-stone-300 hover:bg-stone-600"
                    title="AI Automation — Systems flow"
                  >
        ...
        <section id="products" className="bg-amber-50 py-20">
          <div className="max-w-6xl mx-auto px-6">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <p className="text-stone-600 max-w-2xl mx-auto">
                The 8 projects I'm most proud of. Each one solved a real
                problem, taught me something new, and pushed me to be a better
                builder.
              </p>
            </motion.div>
              ...
              {featuredProjects.map((project, i) => (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <span
                      className={`tag ${project.status === "Live" ? "tag-green" : "tag-amber"}`}
                    >
                      {project.status}
                    </span>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tech.map((t) => (
                      <span key={t} className="tag tag-stone">
                        {t}
                      </span>
                    ))}
                  </div>
        ...
        <section id="projects" className="max-w-6xl mx-auto px-6 py-20">
          ...
          >
            ...
            <p className="text-stone-600 max-w-2xl mx-auto">
              Every project I've built, organized by category. Each one taught
              me something. Some are polished. Some are experiments. All
              represent hours of learning.
            </p>
          </motion.div>
                  ...
                  <div className="space-y-6">
                    <div className="border-l-2 border-amber-300 pl-6">
                      ...
                      <p className="text-stone-600 text-sm leading-relaxed">
                        ...
                        Specialized in React, Next.js, and AI integration. Led
                        development of multiple client projects from concept to
                        deployment.
                      </p>
                    </div>
                  </div>
              ...
              <div className="space-y-6">
                ...
                <div className="indie-card">
                  ...
                  <div className="space-y-3">
                    ...
                    <a
                      href="https://linkedin.com/in/kazi-musharraf"
                      target="_blank"
                      rel="noopener"
                      className="flex items-center gap-2 text-stone-600 hover:text-amber-600 transition-colors"
                    >
        ...
        <section id="contact" className="max-w-6xl mx-auto px-6 py-20">
          ...
          >
            ...
            <p className="text-stone-600 max-w-xl mx-auto mb-8">
              Have an idea? Want to collaborate? Or just want to chat about
              indie hacking? I'm always open to interesting conversations.
            </p>
